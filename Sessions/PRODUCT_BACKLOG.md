...
- 📋 4 orphaned dead-code routes found during the audit, zero callers anywhere in app/ or components/ for any of them: bet/lock, flirts/unread, game-room/challenge/start, game-room/lobby-status. Left untouched (not fixed, not deleted) — pending Matt's confirmation to delete.
