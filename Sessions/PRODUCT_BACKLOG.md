...
### Daily Rhythm
- 🟡 "Now do this" post-activity mechanic — after Spark, Bet, Notice etc. External advisor flagged this gap. Design discussion started July 28: give users something to actually go do in the real world (with/about their partner, or for themselves) after each daily activity, not just "answer and done." TBD: where it lives without cluttering home page, whether it's per-activity or a shared mechanic, format (push? inline card? separate surface?).
