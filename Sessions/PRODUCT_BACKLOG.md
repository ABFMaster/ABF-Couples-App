...
- 📋 Signals audit requested by Matt July 31 — what history the app could draw into Memory Test (or Nora generally) beyond Spark/Bet/Timeline. In progress, see Audit findings below once complete.
...
- 📋 Signals audit still open — see Game Room section above. Matt asked whether Memory Test (or Nora more broadly) is using every available signal in the app: Flirts, Dates, Ritual, Follow-Through, Ahead, Assessment, Wednesday/Thursday. Separate pass, not yet done.
