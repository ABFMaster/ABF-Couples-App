export const GAME_MODE_CONFIG = {
  ...
  'challenge': {
    ...
    hasTimer: false, // timer is in-game, not pre-game
    materials: [
      { emoji: '✏️', text: 'Pen and paper if you have it' },
      { emoji: '📝', text: 'Decide who\'s writing first — you\'ll rotate each round' },
      { emoji: '⏱️', text: 'A timer starts the moment your challenge is revealed' },
    ],
