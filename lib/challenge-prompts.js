...
export const CHALLENGE_PROMPTS = {
  ...
  memory: [
    ...
    { key: 'memory_58', category: 'present_day', hintStrategy: 'present_day', prompt: 'What stresses is your partner currently facing — the ones sitting just below the surface?' },
    { key: 'memory_59', category: 'present_day', hintStrategy: 'present_day', prompt: 'What are some important events coming up in your partner\'s life, and how do they feel about them?' },
    { key: 'memory_60', category: 'present_day', hintStrategy: 'present_day', prompt: 'What is your partner\'s greatest source of support right now, other than you?' },
    { key: 'memory_61', category: 'present_day', hintStrategy: 'present_day', prompt: 'Name one concern or worry your partner is sitting with right now.' },
    { key: 'memory_62', category: 'present_day', hintStrategy: 'present_day', prompt: 'What medical or health concern has your partner mentioned that they quietly think about?' },
    { key: 'memory_63', category: 'present_day', hintStrategy: 'present_day', prompt: 'Of all the people you both know, who does your partner like the least — and why?' },
    { key: 'memory_64', category: 'present_day', hintStrategy: 'present_day', prompt: 'Who are your partner\'s best friends or closest allies right now — has that list shifted recently?' },
    { key: 'memory_65', category: 'present_day', hintStrategy: 'present_day', prompt: 'How is your partner feeling about their work right now — energised, drained, somewhere in between?' },
    { key: 'memory_66', category: 'present_day', hintStrategy: 'present_day', prompt: 'What is the most exciting thing happening in your partner\'s life right now?' },
    { key: 'memory_67', category: 'present_day', hintStrategy: 'present_day', prompt: 'Has your partner changed in the last year — how would they describe it?' },
    { key: 'memory_68', category: 'present_day', hintStrategy: 'present_day', prompt: 'What are your partner\'s goals just for themselves right now — not for the relationship, just them?' },
    { key: 'memory_69', category: 'present_day', hintStrategy: 'present_day', prompt: 'What have been the highlights and low points of the last year for your partner?' },
    { key: 'memory_70', category: 'present_day', hintStrategy: 'present_day', prompt: 'What qualities does your partner value most in their friendships right now?' },
  ],
