...
export const CHALLENGE_PROMPTS = {
  ...
  memory: [
    ...
    { key: 'memory_02', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is {answerHolder}\'s favorite musical artist, composer, or genre — the one they always come back to?' },
    ...
    { key: 'memory_04', category: 'small_things', hintStrategy: 'small_things', prompt: 'Name one of {answerHolder}\'s hobbies — something they actually do, not something they say they\'ll get back to.' },
    ...
    { key: 'memory_08', category: 'small_things', hintStrategy: 'small_things', prompt: 'Who is {answerHolder}\'s favorite relative — the one they actually light up around?' },
    ...
    { key: 'memory_10', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is {answerHolder}\'s favorite way to spend an evening when they get to choose?' },
    ...
    { key: 'memory_15', category: 'small_things', hintStrategy: 'small_things', prompt: 'What does {answerHolder} most like to do with time off — not what they should do, what they actually do?' },
    ...
    { key: 'memory_21', category: 'small_things', hintStrategy: 'small_things', prompt: 'What kinds of books does {answerHolder} most like to read — or wish they had time to read?' },
    ...
    { key: 'memory_31', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is {answerHolder} currently reading, or what do they wish they were reading?' },
    ...
    { key: 'memory_33', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'What is {answerHolder}\'s fondest unrealized dream — the one they don\'t talk about much anymore?' },
    ...
    { key: 'memory_35', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'What makes {answerHolder} feel most competent — the situations where they come alive?' },
    ...
    { key: 'memory_41', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'Does {answerHolder} have a secret ambition — something they want but rarely say out loud?' },
    ...
    { key: 'memory_44', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'If {answerHolder} could instantly possess three skills, what would they choose?' },
    ...
    { key: 'memory_52', category: 'shared_history', hintStrategy: 'shared_history', prompt: 'What was {answerHolder}\'s most embarrassing moment — the one they can laugh about now?' },
    { key: 'memory_53', category: 'shared_history', hintStrategy: 'shared_history', prompt: 'What was {answerHolder}\'s worst childhood experience — something that shaped who they became?' },
    ...
    { key: 'memory_55', category: 'shared_history', hintStrategy: 'shared_history', prompt: 'If {answerHolder} could redo a five-year period of their life, which would they choose and why?' },
    ...
    { key: 'memory_59', category: 'present_day', hintStrategy: 'present_day', recyclable: true, prompt: 'What are some important events coming up in {answerHolder}\'s life, and how do they feel about them?' },
    ...
    { key: 'memory_62', category: 'present_day', hintStrategy: 'present_day', recyclable: true, prompt: 'What medical or health concern has {answerHolder} mentioned that they quietly think about?' },
    ...
    { key: 'memory_67', category: 'present_day', hintStrategy: 'present_day', recyclable: true, prompt: 'Has {answerHolder} changed in the last year — how would they describe it?' },
