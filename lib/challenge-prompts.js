...
export const CHALLENGE_PROMPTS = {
  ...
  memory: [
    ...
    { key: 'memory_01', category: 'small_things', hintStrategy: 'small_things', prompt: 'Name two of your partner\'s closest friends right now — not historically, right now.' },
    { key: 'memory_02', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner\'s favorite musical artist, composer, or genre — the one they always come back to?' },
    { key: 'memory_03', category: 'small_things', hintStrategy: 'small_things', prompt: 'What was your partner wearing the first time you met?' },
    { key: 'memory_04', category: 'small_things', hintStrategy: 'small_things', prompt: 'Name one of your partner\'s hobbies — something they actually do, not something they say they\'ll get back to.' },
    { key: 'memory_05', category: 'small_things', hintStrategy: 'small_things', prompt: 'Where was your partner born?' },
    { key: 'memory_06', category: 'small_things', hintStrategy: 'small_things', prompt: 'When is your partner\'s birthday?' },
    { key: 'memory_07', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is the date of your anniversary?' },
    { key: 'memory_08', category: 'small_things', hintStrategy: 'small_things', prompt: 'Who is your partner\'s favorite relative — the one they actually light up around?' },
    { key: 'memory_09', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner\'s favorite meal — the one they\'d choose if nothing was off the table?' },
    { key: 'memory_10', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner\'s favorite way to spend an evening when they get to choose?' },
    { key: 'memory_11', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner\'s favorite color?' },
    { key: 'memory_12', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is the best gift you could give your partner right now — something they\'d actually want?' },
    { key: 'memory_13', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner\'s favorite way to relax when they\'re genuinely unwinding?' },
    { key: 'memory_14', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner\'s favorite sport or physical activity?' },
    { key: 'memory_15', category: 'small_things', hintStrategy: 'small_things', prompt: 'What does your partner most like to do with time off — not what they should do, what they actually do?' },
    { key: 'memory_16', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is one of your partner\'s favorite weekend activities?' },
    { key: 'memory_17', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner\'s dream getaway — the place they\'d go if logistics didn\'t matter?' },
    { key: 'memory_18', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner\'s favorite movie?' },
    { key: 'memory_19', category: 'small_things', hintStrategy: 'small_things', prompt: 'What are your partner\'s favorite ways to work out or stay active?' },
    { key: 'memory_20', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner\'s favorite holiday?' },
    { key: 'memory_21', category: 'small_things', hintStrategy: 'small_things', prompt: 'What kinds of books does your partner most like to read — or wish they had time to read?' },
    { key: 'memory_22', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner\'s favorite TV show right now?' },
    { key: 'memory_23', category: 'small_things', hintStrategy: 'small_things', prompt: 'Which side of the bed does your partner prefer?' },
    { key: 'memory_24', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner\'s favorite ice cream flavor?' },
    { key: 'memory_25', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner\'s favorite dessert?' },
    { key: 'memory_26', category: 'small_things', hintStrategy: 'small_things', prompt: 'What foods does your partner genuinely hate — not just dislike, actually hate?' },
    { key: 'memory_27', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner\'s favorite animal?' },
    { key: 'memory_28', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner\'s favorite song right now — the one that keeps showing up?' },
    { key: 'memory_29', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner most loyal to — a team, a show, a band, an institution — the thing they\'d defend in any argument?' },
    { key: 'memory_30', category: 'small_things', hintStrategy: 'small_things', prompt: 'What app or podcast has your partner been most into lately?' },
    { key: 'memory_31', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner currently reading, or what do they wish they were reading?' },
    { key: 'memory_32', category: 'small_things', hintStrategy: 'small_things', prompt: 'What is your partner\'s favorite restaurant — the one they\'d pick if you were celebrating something?' },

    // INNER WORLD — dreams, fears, what makes them tick
    { key: 'memory_33', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'What is your partner\'s fondest unrealized dream — the one they don\'t talk about much anymore?' },
    { key: 'memory_34', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'What is your partner\'s greatest fear — not a surface fear, the real one underneath?' },
    { key: 'memory_35', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'What makes your partner feel most competent — the situations where they come alive?' },
    { key: 'memory_36', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'What personal improvements does your partner most want to make in their life right now?' },
    { key: 'memory_37', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'What would your partner consider their dream job — the one they\'d do if money and practicality weren\'t factors?' },
    { key: 'memory_38', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'What is your partner most sad about right now — something they\'re carrying quietly?' },
    { key: 'memory_39', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'Name two people your partner most admires — living or dead.' },
    { key: 'memory_40', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'What are two of your partner\'s deepest aspirations, hopes, or wishes for their life?' },
    { key: 'memory_41', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'Does your partner have a secret ambition — something they want but rarely say out loud?' },
    { key: 'memory_42', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'What is the one thing your partner would most like to change about themselves?' },
    { key: 'memory_43', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'How would your partner like their life to look three years from now — what\'s different?' },
    { key: 'memory_44', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'If your partner could instantly possess three skills, what would they choose?' },
    { key: 'memory_45', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'When it comes to the future, what does your partner worry about most?' },
    { key: 'memory_46', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'If your partner could choose a completely different career, what would it be and why?' },
    { key: 'memory_47', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'Does your partner feel like something is missing from their life right now — what is it?' },
    { key: 'memory_48', category: 'inner_world', hintStrategy: 'inner_world', prompt: 'What adventures does your partner most want to have in their life — the ones still on the list?' },

    // SHARED HISTORY — firsts, specific moments, the story of you two
    { key: 'memory_49', category: 'shared_history', hintStrategy: 'shared_history', prompt: 'What was one of your partner\'s best childhood experiences — a memory they\'ve described more than once?' },
    { key: 'memory_50', category: 'shared_history', hintStrategy: 'shared_history', prompt: 'What was your partner\'s favorite vacation — before you, or together?' },
    { key: 'memory_51', category: 'shared_history', hintStrategy: 'shared_history', prompt: 'Who was your partner\'s best friend in childhood?' },
    { key: 'memory_52', category: 'shared_history', hintStrategy: 'shared_history', prompt: 'What was your partner\'s most embarrassing moment — the one they can laugh about now?' },
    { key: 'memory_53', category: 'shared_history', hintStrategy: 'shared_history', prompt: 'What was your partner\'s worst childhood experience — something that shaped who they became?' },
    { key: 'memory_54', category: 'shared_history', hintStrategy: 'shared_history', prompt: 'What were the best and worst things that happened to your partner as a teenager?' },
    { key: 'memory_55', category: 'shared_history', hintStrategy: 'shared_history', prompt: 'If your partner could redo a five-year period of their life, which would they choose and why?' },
    { key: 'memory_56', category: 'shared_history', hintStrategy: 'shared_history', prompt: 'What is the most exciting thing that has happened in your partner\'s life in the last year?' },
    { key: 'memory_57', category: 'shared_history', hintStrategy: 'shared_history', prompt: 'What have been the highlights and low points of the last year for your partner?' },

    // PRESENT DAY — today\'s map, what\'s happening in their world right now
    { key: 'memory_58', category: 'present_day', hintStrategy: 'present_day', recyclable: true, prompt: 'What stresses is your partner currently facing — the ones sitting just below the surface?' },
    { key: 'memory_59', category: 'present_day', hintStrategy: 'present_day', recyclable: true, prompt: 'What are some important events coming up in your partner\'s life, and how do they feel about them?' },
    { key: 'memory_60', category: 'present_day', hintStrategy: 'present_day', recyclable: true, prompt: 'What is your partner\'s greatest source of support right now, other than you?' },
    { key: 'memory_61', category: 'present_day', hintStrategy: 'present_day', recyclable: true, prompt: 'Name one concern or worry your partner is sitting with right now.' },
    { key: 'memory_62', category: 'present_day', hintStrategy: 'present_day', recyclable: true, prompt: 'What medical or health concern has your partner mentioned that they quietly think about?' },
    { key: 'memory_63', category: 'present_day', hintStrategy: 'present_day', recyclable: true, prompt: 'Of all the people you both know, who does your partner like the least — and why?' },
    { key: 'memory_64', category: 'present_day', hintStrategy: 'present_day', recyclable: true, prompt: 'Who are your partner\'s best friends or closest allies right now — has that list shifted recently?' },
    { key: 'memory_65', category: 'present_day', hintStrategy: 'present_day', recyclable: true, prompt: 'How is your partner feeling about their work right now — energised, drained, somewhere in between?' },
    { key: 'memory_66', category: 'present_day', hintStrategy: 'present_day', recyclable: true, prompt: 'What is the most exciting thing happening in your partner\'s life right now?' },
    { key: 'memory_67', category: 'present_day', hintStrategy: 'present_day', recyclable: true, prompt: 'Has your partner changed in the last year — how would they describe it?' },
    { key: 'memory_68', category: 'present_day', hintStrategy: 'present_day', recyclable: true, prompt: 'What are your partner\'s goals just for themselves right now — not for the relationship, just them?' },
    { key: 'memory_69', category: 'present_day', hintStrategy: 'present_day', recyclable: true, prompt: 'What have been the highlights and low points of the last year for your partner?' },
    { key: 'memory_70', category: 'present_day', hintStrategy: 'present_day', recyclable: true, prompt: 'What qualities does your partner value most in their friendships right now?' },
  ],
