              ...
              >
                ...
                <div
                  style={{
                    position: 'absolute',
                    inset: 0,
                    background: date.photo_url
                      ? `url("${date.photo_url}") center/cover no-repeat, linear-gradient(135deg, #6B5020 0%, #C9A84C 50%, #D4BA7A 100%)`
                      : 'linear-gradient(135deg, #6B5020 0%, #C9A84C 50%, #D4BA7A 100%)'
                  }}
                />
