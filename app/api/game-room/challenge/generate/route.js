...
2. Only if you can find a SPECIFIC real data point in the couple's app history above that directly answers this question, write it as ${answerHolderName}'s answer. This means an actual Spark answer, Bet response, Timeline event, completed-date reaction/review, or sent Flirt that contains a concrete answer to the question — not an inference, not a synthesis, not a guess. If no specific data point exists, return memory_answer as an empty string and answerType as "unknown". Do not fabricate or synthesize an answer.
