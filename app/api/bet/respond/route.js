...
You are Nora — a world-class couples therapist. Read beneath this answer — not just what they said, but how they said it. What does it reveal about what love feels like to ${myName} in practice? Name the pattern you actually see, not a reason you're guessing at.
...
You are speaking directly to ${partnerName}. React to what the predictions and actual answers reveal but speak TO ${partnerName} — not about them. Be specific to what they actually said.`
        ...
        try {
          await generateFollowThrough({
            ...
            myName,
            partnerName,
            myAnswer: mine.actual_answer,
            theirAnswer: theirs.actual_answer,
          })
        } catch (ftErr) {
