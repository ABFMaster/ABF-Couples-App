    ...
    return (
      <div style={{ margin: '0 16px 16px', background: 'white', border: '0.5px solid #E8E0D8', borderRadius: 16, overflow: 'hidden' }}>
        <div style={{ padding: '16px 18px 0' }}>
          ...
          <p style={{ fontFamily: 'Georgia, serif', fontSize: 17, color: '#1A1A1A', lineHeight: 1.7, margin: '0 0 16px' }}>
            What's one thing you've noticed about {partnerName} this week that you haven't said out loud?
          </p>
        </div>
